...
| F15.04 | Link a saved or currently open source fit; edit projected source count, active state and range, and navigate back to edit the source. | D01 | [s072][s072], [s073][s073], [s074][s074], [s182][s182] | NUP | D: —; A: — |
...
| F15.07 | Recalculate all recipients after source modules, skills, implants, charges or state change; avoid stale effects after repeated apply/remove and source deletion. | D02 | [s017][s017], [s233][s233] | NUP | D: —; A: — |
| F15.08 | Match multiple-source stacking for EWAR, remote support, falloff/range and effect resistance; test inactive, zero-range and beyond-range cases. | D02 | [s017][s017], [s006][s006] | NU | D: —; A: — |
