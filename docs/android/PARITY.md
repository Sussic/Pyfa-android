...
| F03.05 | Clone selected modules and apply compatible variation/removal operations to the complete selection. | B05 | [s202][s202], [s200][s200], [s206][s206] | NU | D: [single-clone command and selected composition](evidence/b05-3-native.json), variation/removal pending B05.4; A: [selected clone and native restart](evidence/b05-3-native.json), variation/removal pending B05.4 |
