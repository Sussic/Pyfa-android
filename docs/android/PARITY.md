...
| F02.03 | Load, replace and unload compatible charges/scripts/crystals; reject incompatible charges without partial edits. | B04 | [s093][s093], [s175][s175] | NUP | D: [14 charge cases/74 states and 4,242 compatible sets](evidence/b04-2-3-1-native.json); A: [offline charge/script/crystal editing, rejection and restart](evidence/b04-2-3-1-native.json) |
| F02.04 | Swap/reorder fitted modules, retaining states/charges and changing rack-dependent heat behavior correctly. | B04 | [s208][s208], [s179][s179] | NUP | D: [nine original swap/heat cases, 48 states](evidence/b04-2-3-3-native.json); A: [touch swaps/vacancies, strict heat types and real restart](evidence/b04-2-3-3-native.json) |
| F02.05 | Switch an item to a supported variation in fitted and addition panes; retain or reconcile states and charges. | B04 | [s092][s092], [s174][s174] | NUP | D: [17 variation cases/55 states and 5,226 families](evidence/b04-2-3-2-native.json); A: [module/drone/fit-implant picker, reconciliation, copy/restart](evidence/b04-2-3-2-native.json); later addition editors retain their assigned scope |
| F02.06 | Change tactical modes and supported primary/secondary/tertiary modes; recalculate bonuses and restore the prior mode. | B06 | [s100][s100], [s183][s183], [s018][s018] | NUP | D: [four original mode cases/16 states](evidence/b06-1-native.json); A: [offline touch, copy and real restart](evidence/b06-1-native.json); B09 retains undo/redo |
| F02.07 | Replace strategic-cruiser subsystems and reconcile altered slots, fitting legality and hull bonuses. | B06 | [s019][s019], [s178][s178], [s017][s017] | NUP | D: [original commands, 14 states and 48 choices](evidence/b06-2-native.json); A: [offline touch, illegal-module warning, copy and restart](evidence/b06-2-native.json); B09 retains undo/redo |
...
| ID | Observable behavior / acceptance target | Owner | Sources | Checks | Evidence |
| --- | --- | --- | --- | --- | --- |
| F03.01 | Select multiple compatible weapons and change all selected ammunition in one action; mixed selections do not silently edit unintended modules. | B05 | [s199][s199], [s093][s093] | NU | D: [nine original selection/command cases, 41 states](evidence/b05-1-native.json); A: [explicit scopes, mixed skips, atomic changes and native restart](evidence/b05-1-native.json) |
| F03.02 | Choose same-type-all versus selection-only ammo changes; expose the desktop modifier-key alternative as a touch-accessible choice. | B05 | [s122][s122], [s199][s199] | NUP | D: [nine original selection/command cases, 41 states](evidence/b05-1-native.json); A: [explicit scopes, mixed skips, atomic changes and native restart](evidence/b05-1-native.json) |
| F03.03 | Change selected module states together, including offline, online, active and overheated where supported. | B05 | [s201][s201], [s177][s177] | NU | D: [six original state-command cases, 27 states](evidence/b05-2-native.json); A: [touch scopes, saved outcomes, atomic changes and native restart](evidence/b05-2-native.json) |
| F03.04 | Fill free slots with an item or clones of a fitted module; verify charges, states and stopping limits. | B05 | [s088][s088], [s094][s094], [s204][s204], [s203][s203] | NU | D: [seven original clone/fill cases, 17 states](evidence/b05-3-native.json); A: [touch fill, EOS stopping, state/charge and native restart](evidence/b05-3-native.json) |
| F03.05 | Clone selected modules and apply compatible variation/removal operations to the complete selection. | B05 | [s202][s202], [s200][s200], [s206][s206] | NU | D: [selected clone](evidence/b05-3-native.json), [eight original variation/removal cases and 17 states](evidence/b05-4-native.json); A: [selected clone](evidence/b05-3-native.json), [touch scopes, atomic variation/removal and offline restart](evidence/b05-4-native.json) |
