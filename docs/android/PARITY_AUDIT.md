...
| Q07 | Full projection-cycle, command-source overlap and stacking behavior are not established by source indexing or the single A01 fit. | A04/A05/D02/D03: record independent desktop cases, repeated edits/removals and recipient updates; do not introduce arbitrary cycle suppression or approximate burst formulas. |
