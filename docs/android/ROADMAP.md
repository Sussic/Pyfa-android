...
| B04.2.2 | ready | B04.2.1 | Module editing, legality and recent use | Add/replace/remove modules, rigs and service modules with positions, state rules, EOS legality and restriction re-enable behavior; persist a desktop-matched bounded recent-use list. |
