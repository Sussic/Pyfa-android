...
| B04.2 | ready | B04.1 | Fitting editor and item history | Arbitrary hull creation; module/rig/service add/replace/remove/reorder, compatible charges/variations, restrictions/legality and persistent recent items pass independent numerical, failure/restart and native UI checks. |
