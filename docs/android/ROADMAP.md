...
| B04.1 | active | B03 | Offline equipment discovery | Complete pinned market catalogue, group/search/meta filters and item-to-group navigation pass independent host and offline native checks. |
| B04.2 | queued | B04.1 | Fitting editor and item history | Arbitrary hull creation; module/rig/service add/replace/remove/reorder, compatible charges/variations, restrictions/legality and persistent recent items pass independent numerical, failure/restart and native UI checks. |
