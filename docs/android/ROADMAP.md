...
| B04.2.3 | ready | B04.2.2 | Charges, variations and rack ordering | Compatible ammo/scripts/crystals, active-fit charges, module/addition variations and reordering retain state/charge/location and match independent calculations and native restart workflows. |
