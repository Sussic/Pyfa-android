...
| B04.2.3.2 | active | B04.2.3.1 | Fitted and addition variations | Supported module and existing addition variations reconcile states/charges/locations exactly as desktop with atomic failures, independent values and native restart evidence. |
