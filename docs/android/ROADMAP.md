...
| A05 | active | A03 | Command-burst reference cases | A real booster/source fit and recipient produce matching results with skills/implants/state changes; disabling/removing the command source restores baseline. |
