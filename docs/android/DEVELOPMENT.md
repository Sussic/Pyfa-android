...
has **96 tests** with B04.2.2: 29 headless, 14 bridge, 14 persistence, 13 library,
six equipment discovery, six empty-hull, six module-edit and eight reference utilities, plus
independent calculation/catalogue/empty-hull/module-command exports and migration.
Native CI requires **22 executions**: five functional, separate A10 performance
...
phases. The latter compares 91 states and 4,242 default module states, strict raw
