...
timeout 8m ./gradlew --no-daemon --console=plain :app:connectedDebugAndroidTest \
  -Pandroid.testInstrumentationRunnerArguments.notClass=io.github.sussic.pyfa.PerformanceTest,io.github.sussic.pyfa.BridgeContractTest,io.github.sussic.pyfa.PersistenceTest,io.github.sussic.pyfa.FitLibraryTest,io.github.sussic.pyfa.LibraryNavigationTest,io.github.sussic.pyfa.EquipmentBrowserTest,io.github.sussic.pyfa.EmptyHullTest,io.github.sussic.pyfa.ModuleEditingTest,io.github.sussic.pyfa.ChargeEditingTest,io.github.sussic.pyfa.VariationEditingTest,io.github.sussic.pyfa.RackOrderingTest,io.github.sussic.pyfa.BulkChargesTest,io.github.sussic.pyfa.BulkStatesTest,io.github.sussic.pyfa.CloneFillTest,io.github.sussic.pyfa.BulkVariationRemovalTest,io.github.sussic.pyfa.HullModeTest,io.github.sussic.pyfa.SubsystemTest
collect_screenshots
...
python3 ci/check-empty-hulls.py
python3 ci/check-module-edits.py
python3 ci/check-charge-edits.py
python3 ci/check-variation-edits.py
python3 ci/check-rack-ordering.py
python3 ci/check-bulk-charges.py
