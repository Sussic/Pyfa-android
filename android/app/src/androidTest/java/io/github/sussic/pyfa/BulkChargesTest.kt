        ...
        try {
            when (phase) {
                "prepare" -> {
                    ...
                    click("bulk-back"); click("bulk-clear"); click("bulk-reference-0"); click("bulk-choose")
                    assertEquals(setOf(0), picker.selected)
                    click("bulk-scope-SIMILAR"); choose("Iron Charge M", iron)
                    compose.onNodeWithTag("bulk-preview-2").performScrollTo().assertTextContains("Will load", substring = true)
                    ...
                    click("bulk-back"); click("bulk-select-all"); click("bulk-reference-0"); click("bulk-choose")
