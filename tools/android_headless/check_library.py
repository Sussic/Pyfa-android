#!/usr/bin/env python3
"""Run real B03.1 library lifecycle tests with pinned data and headless guards."""
import argparse
import hashlib
...
def main():
    ...
    if args.worker:
        ...
        spec = importlib.util.spec_from_file_location("bridge_tests", Path(__file__).parent / "tests/test_library.py")
